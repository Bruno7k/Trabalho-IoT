...
void loop() {
  ...
  if (app.ready()) {
    ...
    if (currentTime - lastSendTime >= sendInterval) {
      ...
      // Enviar ao Firebase em /microfone2
      Database.set<float>(aClient, "/microfone2/rms", rmsAverage, processaResultados, "Envio_RMS");
      ...
      Database.set<String>(aClient, "/microfone2/alerta", alerta, processaResultados, "Envio_Alerta");
    }
  }
}
